...
int main(int argc, char* argv[]){
  ...
  const int nEvents = 84;
  const UInt_t theEventNumbers[nEvents] = {26323378, 27569662, 27897245, 28254843, 28627679, // 5
					   28776748, 28930237, 28934295, 29006913, 29008144, // 10
					   32879955, 32953817, 34745811, 34757629, 35020101, // 15
					   35116217, 35118197, 36710262, 37009416, 37009533, // 20
					   37009810, 38273261, 38619569, 39464799, 40633613, // 25
					   40646231, 40996918, 41492058, 41654702, 41799439, // 30
					   42256877, 42699600, 44675867, 45985415, 47512906, // 35
					   47831713, 48225288, 48242449, 49313992, 50827460, // 40
					   51950538, 53275871, 55496464, 55504417, 55861013, // 45
					   56463512, 56829451, 56894100, 57108465, 57471113, // 50
					   57519585, 57523926, 57654756, 57839882, 57948519, // 55
					   58002861, 58008286, 58110716, 58226572, 58310817, // 60
					   58326495, 58332241, 58421469, 59967256, 60072506, // 65
					   61104509, 61173194, 61215330, 61238684, 61497702, // 70
					   61534104, 61784557, 61876418, 62235301, 62235933, // 75
					   62420819, 62732869, 62849802, 63024583, 63031985, // 80
					   63484004, 63714468, 63845258, 63845261};          // 84
  ...
  if(N > 0){    
    ...
    const Long64_t nLoop = type ? N : nEvents;
	...
	ss.getEvent(theEventNumbers[entryInd]);
      }
